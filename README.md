...
по ссылке), сохраняешь, масштабируешь порции, смотришь КБЖУ на порцию и на 100 г,
добавляешь фото блюда и шагов.

**Живая версия:** https://receitas-nine-rho.vercel.app
